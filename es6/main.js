var liukuku = function(window, $) {
    ...
    p1Ani.from($(".p1Page"), 1.2, { autoAlpha: 0, y: -1560, ease: Elastic.easeInOut.config(1, 1) })
        .from($(".p1Page .frame .title1"), .5, { autoAlpha: 0, x: -350, ease: Power4.easeInOut }, .8)
        .from($(".p1Page .frame .title2"), .5, { autoAlpha: 0, x: 350, ease: Power4.easeInOut }, .8)
        .from($(".p1Page .frame .wdk1"), .8, { autoAlpha: 0, scale: 3, ease: Back.easeIn.config(5) }, 1)
        .from($(".p1Page .frame .wdk2"), .8, { autoAlpha: 0, scale: 3, ease: Back.easeIn.config(5) }, 1.25)
        .from($(".p1Page .frame .wdk3"), .8, { autoAlpha: 0, scale: 3, ease: Back.easeIn.config(5) }, 1.5)
        .fromTo($(".p1Page .frame .yun1"), 5, { scale: .85 }, { scale: .95, repeat: -1, yoyo: true, ease: Power0.easeNone }, 1.9)
        .fromTo($(".p1Page .frame .yun2"), 5, { scale: .95 }, { scale: 1.1, repeat: -1, yoyo: true, ease: Power0.easeNone }, 2.7)
        .to($(".p1Page .frame .fc"), 1, { rotationZ: 360, repeat: -1, ease: Power0.easeNone }, 0)
        .to($(".p1Page .frame .l1"), 1.5, { y: 15, repeat: -1, yoyo: true, ease: Power0.easeNone, delay: .1 }, 0)
        .to($(".p1Page .frame .l2"), 1.4, { y: 15, repeat: -1, yoyo: true, ease: Power0.easeNone, delay: 0 }, 0)
        .to($(".p1Page .frame .l3"), 1.3, { y: 15, repeat: -1, yoyo: true, ease: Power0.easeNone, delay: .2 }, 0)
        .to($(".p1Page .frame .l4"), 1.6, { y: 15, repeat: -1, yoyo: true, ease: Power0.easeNone, delay: .3 }, 0)
        .to($(".p1Page .frame .lc"), 6, {
                // y: -104,
                // x: 239,
                repeat: -1,
                yoyo: true,
            ...
            0);
    rulesAni.from($(".rulesPage .f1"), .5, { autoAlpha: 0, y: -200 })
        .from($(".rulesPage .f2"), .5, { autoAlpha: 0, y: -200 }, .2)
        .from($(".rulesPage .f3"), .5, { autoAlpha: 0, y: -200 }, .4)
    timeAni.to($(".time_z1"), 6, { rotationZ: -360, repeat: -1, ease: Power0.easeNone, transformOrigin: "center bottom" }, 0)
        .to($(".time_z2"), 1, { rotationZ: -360, repeat: -1, ease: Power0.easeNone, transformOrigin: "left center" }, 0)
        .to($(".time_pre"), 10, { "width": "0px" }, 0)
    // timeAni.play()
    ...
    function loadImg() {
        ...
        function handleComplete() {
            $(".loadPage").fadeOut(500, function() { $(this).remove() })
            p1Ani.play()
            myAni.play();
        };
    };
    ...
    discolourAni.prototype.play = function() {
        ...
        _this.st1 = setTimeout(() => {
            TweenMax.to($(_this.dom).find(".tipHand"), .5, {
                x: 0,
                y: 0,
                onComplete: function() {
                    _this.ss1 = setInterval(() => {
                        if (_this.s1num) {
    ...
    $(".close").on("click", function() {
        $(".rulesPage").fadeOut(500, function() { rulesAni.pause(0); })
    })
    ...
    //字体加载
    var gwqzt = function(name, url, fun) {
        var gwqmyFont = new FontFace(name, 'url(' + url + ')')
        gwqmyFont.load().then(font => {
